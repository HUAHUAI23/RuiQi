...
type MicroRule struct {
	...
	Condition bson.Raw      `json:"condition" bson:"condition" example:"{\"type\":\"composite\",\"operator\":\"AND\",\"conditions\":[{\"type\":\"simple\",\"target\":\"source_ip\",\"match_type\":\"in_ipgroup\",\"match_value\":\"blocked_ips\"},{\"type\":\"simple\",\"target\":\"path\",\"match_type\":\"regex\",\"match_value\":\"^/admin/.*$\"}]}"` // 规则条件，支持复合条件(composite)和简单条件(simple)
}
