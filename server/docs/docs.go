...
const docTemplate = `{
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/model.MicroRule"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "model.MicroRule": {
            ...
            "properties": {
                "condition": {
                    "description": "@Schema(type=object, example={\"type\":\"composite\",\"operator\":\"AND\",\"conditions\":[{\"type\":\"simple\",\"target\":\"source_ip\",\"match_type\":\"in_ipgroup\",\"match_value\":\"blocked_ips\"},{\"type\":\"simple\",\"target\":\"path\",\"match_type\":\"regex\",\"match_value\":\"^/admin/.*$\"}]})",
                    "type": "object"
                },
                "id": {
                    "description": "规则唯一标识符",
